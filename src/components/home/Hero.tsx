          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            {whatsappNumber && (
              <button
                ...
                className="bg-[#25D366] text-white px-10 py-5 rounded-2xl font-bold text-lg flex items-center justify-center gap-2 hover:bg-[#128C7E] transition-all hover:scale-105 shadow-xl shadow-[#25D366]/20"
              >
